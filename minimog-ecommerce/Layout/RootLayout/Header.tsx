            ...
            <div className="max-w-7xl mx-auto py-1 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden lg:flex items-center space-x-6">
                        {menuItems.map((item, index) => (
                            <div key={index} className="group relative">
                                <button className="flex items-center space-x-1 text-black hover:text-gray-900 text-[15px] font-medium transition-colors outline-none py-2">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <button className="p-2 text-black hover:text-gray-800 transition-colors relative">
                            <Heart size={20} />
                        </button>
                        <button className="p-2 text-black hover:text-gray-800 transition-colors relative">
